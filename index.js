 ...
 * If the person is old enough, return a string
 ...
 * that number. If the number is 1 returns, "You
 * win first prize". If the number is 2, returns:
 * 'You win second prize'. If the number is 3,
